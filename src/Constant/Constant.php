...
class Constant
{
    ...
    public static function defaultPermissions()
    {
        ...
        return[
            ...
            ['uuid' => (string)Uuid::generate(4), 'serial' => 4, 'name' => 'Correspondents', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 5, 'name' => 'Pages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 6, 'name' => 'Tags', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 7, 'name' => 'Keywords', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 8, 'name' => 'Roles & Permissions', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 9, 'name' => 'Roles', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 10, 'name' => 'Permissions', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 11, 'name' => 'Assign Access', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 12, 'name' => 'Manage Users', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 13, 'name' => 'Create & Manage Users', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 14, 'name' => 'Administrators', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 15, 'name' => 'Users', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 16, 'name' => 'Subscribers', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 17, 'name' => 'Employees', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 18, 'name' => 'Add Post', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 19, 'name' => 'Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 20, 'name' => 'Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 21, 'name' => 'Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 22, 'name' => 'View Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 23, 'name' => 'Article Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 24, 'name' => 'Breaking Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 25, 'name' => 'Headline Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 26, 'name' => 'Latest Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 27, 'name' => 'Feature Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 28, 'name' => 'Popular Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 29, 'name' => 'Approved Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 30, 'name' => 'Private Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 31, 'name' => 'Pending Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 32, 'name' => 'Scheduled Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 33, 'name' => 'Draft Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 34, 'name' => 'View Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 35, 'name' => 'Gallery Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 36, 'name' => 'Approved Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 37, 'name' => 'Private Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 38, 'name' => 'Pending Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 39, 'name' => 'Scheduled Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 40, 'name' => 'Draft Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 41, 'name' => 'View Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 42, 'name' => 'Video Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 43, 'name' => 'Approved Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 44, 'name' => 'Private Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 45, 'name' => 'Pending Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 46, 'name' => 'Scheduled Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 47, 'name' => 'Draft Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 48, 'name' => 'Poll', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 49, 'name' => 'Vote', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 50, 'name' => 'Ad Spaces', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 51, 'name' => 'Breaking Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 52, 'name' => 'Latest Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 53, 'name' => 'Trending Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 54, 'name' => 'News Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 55, 'name' => 'Ad Positions', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 56, 'name' => 'Header Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 57, 'name' => 'Middle Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 58, 'name' => 'Footer Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 59, 'name' => 'Side Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 60, 'name' => 'Ad Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 61, 'name' => 'Middle Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 62, 'name' => 'Footer Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 63, 'name' => 'Google AdSense', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 64, 'name' => 'Manage Comments', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 65, 'name' => 'Comments', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 66, 'name' => 'Comment Replays', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 67, 'name' => 'Contact Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 68, 'name' => 'Add Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 69, 'name' => 'Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 70, 'name' => 'Message Replays', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 71, 'name' => 'Mailbox', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 72, 'name' => 'Add Mail', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 73, 'name' => 'Compose', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 74, 'name' => 'Mailbox Users', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 75, 'name' => 'Mailbox Administrators', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 76, 'name' => 'Mailbox Subscribers', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 77, 'name' => 'Mailbox Sent', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 78, 'name' => 'Mailbox Draft', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 79, 'name' => 'SEO Tools', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 80, 'name' => 'Page SEO', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 81, 'name' => 'SEO Activities', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 82, 'name' => 'Google Analytics', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 83, 'name' => 'Color Management', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 84, 'name' => 'Font Management', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 85, 'name' => 'Configurations', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 86, 'name' => 'General Settings', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 87, 'name' => 'Preferences', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 88, 'name' => 'Limitations', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 89, 'name' => 'Database Backup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 90, 'name' => 'Assets Backup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
        ];
    }
    ...
    public static function defaultConfigurations()
    {
        ...
        return [
            ...
            'profile_image_format' => 'jpg', 'profile_image_accepts' => json_encode(static::defaultImageAccepts()),
            'profile_image_size' => json_encode(static::defaultProfileSize()),
            'cover_image_format' => 'jpg',
            'cover_image_accepts' => json_encode(static::defaultImageAccepts()),
            'cover_image_size' => json_encode(static::defaultCoverSize()),
            'post_image_format' => 'jpg', 'post_image_accepts' => json_encode(static::defaultImageAccepts()),
            'post_image_size' => json_encode(static::defaultPostImageSize()),
            'ad_image_format' => 'jpg', 'ad_image_accepts' => json_encode(static::defaultImageAccepts()),
            'ad_image_size' => json_encode(static::defaultAdImageSize()),
            'video_format' => 'mp4',
            'video_accepts' => json_encode(static::defaultVideoAccepts()),
            'file_format' => json_encode(static::defaultFileFormat()),
            'file_accepts' => json_encode(static::defaultFileAccepts()),
            'created_by' => 1,
            'created_at' => $now,
            'updated_at' => $now,
        ];
