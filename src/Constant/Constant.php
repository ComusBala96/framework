...
class Constant
{
    ...
    public static function defaultPermissions()
    {
        ...
        return[
            ...
            ['uuid' => (string)Uuid::generate(4), 'serial' => 16, 'name' => 'Employees', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 17, 'name' => 'Add Post', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 18, 'name' => 'Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 19, 'name' => 'Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 20, 'name' => 'Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 21, 'name' => 'View Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 22, 'name' => 'Article Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 23, 'name' => 'Breaking Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 24, 'name' => 'Headline Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 25, 'name' => 'Latest Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 26, 'name' => 'Feature Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 27, 'name' => 'Popular Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 28, 'name' => 'Approved Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 29, 'name' => 'Private Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 30, 'name' => 'Pending Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 31, 'name' => 'Scheduled Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 32, 'name' => 'Draft Article', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 33, 'name' => 'View Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 34, 'name' => 'Gallery Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 35, 'name' => 'Approved Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 36, 'name' => 'Private Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 37, 'name' => 'Pending Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 38, 'name' => 'Scheduled Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 39, 'name' => 'Draft Gallery', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 40, 'name' => 'View Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 41, 'name' => 'Video Posts', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 42, 'name' => 'Approved Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 43, 'name' => 'Private Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 44, 'name' => 'Pending Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 45, 'name' => 'Scheduled Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 46, 'name' => 'Draft Video', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 47, 'name' => 'Poll', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 48, 'name' => 'Vote', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 49, 'name' => 'Ad Spaces', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 50, 'name' => 'Breaking Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 51, 'name' => 'Latest Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 52, 'name' => 'Trending Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 53, 'name' => 'News Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 54, 'name' => 'Ad Positions', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 55, 'name' => 'Header Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 56, 'name' => 'Middle Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 57, 'name' => 'Footer Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 58, 'name' => 'Side Ad', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 59, 'name' => 'Ad Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 60, 'name' => 'Middle Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 61, 'name' => 'Footer Popup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 62, 'name' => 'Google AdSense', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 63, 'name' => 'Manage Comments', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 64, 'name' => 'Comments', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 65, 'name' => 'Comment Replays', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 66, 'name' => 'Contact Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 67, 'name' => 'Add Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 68, 'name' => 'Messages', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 69, 'name' => 'Message Replays', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 70, 'name' => 'Mailbox', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 71, 'name' => 'Add Mail', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 72, 'name' => 'Compose', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 73, 'name' => 'Mailbox Users', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 74, 'name' => 'Mailbox Administrators', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 75, 'name' => 'Mailbox Subscribers', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 76, 'name' => 'Mailbox Sent', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 77, 'name' => 'Mailbox Draft', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 78, 'name' => 'SEO Tools', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 79, 'name' => 'Page SEO', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 80, 'name' => 'SEO Activities', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 81, 'name' => 'Google Analytics', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 82, 'name' => 'Color Management', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 83, 'name' => 'Font Management', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 84, 'name' => 'Configurations', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 85, 'name' => 'General Settings', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 86, 'name' => 'Preferences', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 87, 'name' => 'Limitations', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 88, 'name' => 'Database Backup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
            ['uuid' => (string)Uuid::generate(4), 'serial' => 89, 'name' => 'Assets Backup', 'guard_name' => 'web', 'created_by' => 1, 'created_at' => $now, 'updated_at' => $now, ],
        ];
    }
